...
inline const std::map< tristan::sockets::Error, const char* > g_socket_code_descriptions{
    ...
    {tristan::sockets::Error::SOCKET_SET_TIMEOUT_ERROR,                  "Failed to set SO_RCVTIMEO and SO_SNDTIMEO options"                                                         },
    ...
    {tristan::sockets::Error::ACCEPT_ALREADY_CONNECTED,                  "The socket is already connected"                                                                           },
    ...
    {tristan::sockets::Error::ACCEPT_NOT_ENOUGH_MEMORY,
    ...
    {tristan::sockets::Error::WRITE_USER_QUOTA,                          "The user's quota of disk blocks on the filesystem containing the file referred to by fd has been exhausted"},
    ...
    {tristan::sockets::Error::WRITE_IS_CONNECTED,                        "The connection-mode socket was connected already but a recipient was specified"                            },
    {tristan::sockets::Error::WRITE_MESSAGE_SIZE,
     "The socket type requires that message be sent atomically, and the size of the message to be sent made this impossible"                                                         },
    {tristan::sockets::Error::WRITE_NO_BUFFER,                           "The output queue for a network interface was full"                                                         },
    {tristan::sockets::Error::WRITE_NO_MEMORY,                           "No memory available"                                                                                       },
    {tristan::sockets::Error::WRITE_NOT_CONNECTED,                       "The socket is not connected, and no target has been given"                                                 },
    {tristan::sockets::Error::WRITE_NOT_SOCKET,                          "The file descriptor does not refer to a socket"                                                            },
    {tristan::sockets::Error::WRITE_NOT_SUPPORTED,                       "Some bit in the flags argument is inappropriate for the socket type"                                       },
    ...
    {tristan::sockets::Error::READ_CONNECTION_REFUSED,                   "A remote host refused to allow the network connection"                                                     },
    ...
    {tristan::sockets::Error::READ_NO_MEMORY,                            "Could not allocate memory"                                                                                 },
    ...
    {tristan::sockets::Error::SHUTDOWN_NOT_ENOUGH_MEMORY,                "Insufficient resources were available in the system to perform the operation"                              },
};
